      ...
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div v-else class="grid grid-cols-3 md:grid-cols-6 gap-3">
          <RouterLink v-for="cat in displayCategories" :key="cat.id || cat.name"
            ...
            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl flex items-center justify-center text-2xl sm:text-3xl mx-auto mb-2 sm:mb-3">{{ catIcon(cat.name) }}</div>
      ...
      <div class="max-w-5xl mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          <div v-for="(step, i) in steps" :key="i" class="text-center relative">
            <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-red-50 to-orange-50 border-2 border-dashed border-red-200 flex items-center justify-center text-2xl sm:text-3xl mx-auto mb-3 sm:mb-4 relative hover:scale-110 transition">
              {{ step.icon }}
        ...
        <div class="grid lg:grid-cols-5 gap-8 lg:gap-10 items-center">
          ...
          <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div v-for="w in whyUs" :key="w.title" class="flex items-start gap-4 bg-white rounded-2xl p-4 sm:p-5 shadow-sm hover:-translate-y-1 hover:shadow-md transition">
              <div :class="`w-10 h-10 sm:w-12 sm:h-12 rounded-2xl flex items-center justify-center text-xl flex-shrink-0 ${w.bg}`">{{ w.icon }}</div>
              <div>
